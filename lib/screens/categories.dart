...
class _CategoriesState extends State<Categories> {
  ...
  Future<String> _fetchUrl() async {
    ...
    final response = await http.get(
      Uri.parse(url),
      headers: {'Authorization': '$accessToken'}, // Include 'Bearer' before the token
    );
    ...
    if (response.statusCode == 200) {
      final decodedResponse = json.decode(response.body); // The response body is already a string
